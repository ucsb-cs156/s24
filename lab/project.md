...
On {{ page.assigned | date: '%B %d, %Y, hh:mm' }}, in section, we'll launch the legacy code projects.

This page describes how that will roll out.

# Due Date

The due date for getting PRs in, green on CI, and reviewed by a member of your student team is {{ page.due | date: '%B %d, %Y, hh:mm' }}, i.e. at the *start* of class that day (typically the last class day of week 9).
...
The staff will work with you to set up dokku prod and qa instances; that will happen on Thursday May 16.
