...
* `UCSBDate`, which represents dates from the UCSB calendar.
  ...
  The `yyyyq` format  has the advantage that when you sort, the quarters come out in the right order.  That would not be true if you sorted `['F22', 'W23', 'S23','s24', 's24']` in lexicographic order; they would come out `['F22', 's24', 's24','S23', 'W23']` which is an order that makes no sense.

  For reference only,
  here's a complete list of UCSBDates for s24. This list is in the original
  format used by the
