...
|-|-|
| `JokeIT.java` | `JokeWebIT.java` | 
| `LocationIT.java` | `LocationWebIT.java` | 
| `PublicHolidaysIT.java` | `PublicHolidaysWebIT.java` | 
| `TidesIT.java` | `TidesWebIT.java` | 
| `UniversityIT.java` | `UniversityWebIT.java` | 
| `ZipCodeIT.java` | `ZipCodeWebIT.java` | 
